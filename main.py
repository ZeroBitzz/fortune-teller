...
fortuneArr = [
    ...
    'A small donation is call for. Its the right thing to do.',
    ...
    'Dont confuse recklessness with confidence. (2)',
    ...
    'Get your mind set…confidence will lead you on.',
    'Go for the gold today! Youll be the champion of whatever.',
    ...
    'If youre feeling down, try throwing yourself into your work.',
    'Imagination rules the world.',
    'In order to take, one must first give.',
    'In the end all things will be known.',
    'In this world of contradiction, Its better to be merry than wise.',
    ...
    'Its not the amount of time you devote, but what you devote to the time that counts.',
    ...
    'One can never fill anothers shoes, rather he must outgrow the old shoes.',
    ...
    'Stand tall. Dont look down upon yourself. (2)',
    ...
    'Theres no such thing as an ordinary cat.',
    'Things dont just happen; they happen just.',
    'Those who care will make the effort.',
    'Time and patience are called for many surprises await you!. (sic)',
    'Time is precious, but truth is more precious than time',
    'To know oneself, one should assert oneself.',
    'To the world you may be one person, but to one person you may be the world.',
    'Today is the conserve yourself, as things just wont budge.',
    ...
    'Whats yours in mine, and whats mine is mine.',
    'When more become too much. Its same as being not enough.',
...
print("----------")
question = input("Well, " + name + ". Would you like to know your fortune(y/n)? ")
print("----------")
if question == "y":
    fortuneIndex = random.randrange(1 , (len(fortuneArr) - 1))
    print("...")
    time.sleep(1)
    print("...")
    time.sleep(1)
